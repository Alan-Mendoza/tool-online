...
<main class="main-wrapper">
    <div class="main-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Editar base</div>
            <div class="ps-3">
            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Actualizar base</h5>
                            <form action="{{ route('bases.update', ['basis' => $base->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') ?? $base->name }}" placeholder="base" autofocus>
                                            @error('name')
