                                            ...
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                @foreach ($roles as $id => $role)
                                                    <div class="form-check form-check-success">
                                                        <input class="form-check-input" type="checkbox" name="roles[]" value="{{ $id }}" {{ $user->roles->contains($id) ? 'checked' : '' }} id="flexCheckSuccess{{ $id }}">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                @foreach ($permissions as $id => $permission)
                                                    <div class="form-check form-check-success">
                                                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $id }}" {{ $user->permissions->contains($id) ? 'checked' : '' }} id="flexCheckSuccess{{ $id }}">
                                                        <label class="form-check-label" for="flexCheckSuccess{{ $id }}">
                                                            {{ $permission }}
                                                        </label>
                                                    </div>
