            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-body p-4">
                        <h5 class="mb-4">Actualizar rol</h5>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') ?? $role->name }}" placeholder="rol" autofocus>
                                            @error('name')
